        ...
        <div className='main'>
            <form>
              ...
              <div className='name'>
                ...
                <input type='text' className='input' placeholder='お名前を入力してください' value={name} onChange={(e) => setName(e.target.value)} />
              </div>

              <div className='mail'>
                <p className='inputMailTitle'>メールアドレス</p>
                <input type='mail' className='input' placeholder='メールアドレスを入力してください' value={mail} onChange={(e) => setMail(e.target.value)} />
              </div>

              <div className='birthDay'>
                <p className='inputTitle'>生年月日</p><br/>
                <input type="date" className='inputDate' name="birthday" value={birthday} onChange={(e) => setBirthday(e.target.value)} />
              </div>

              <div className='gender'>
                <p className='inputGenderTitle'>性別</p><br/>
                <select name='inputGender' className='inputGender' value={gender} onChange={(e) => setGender(e.target.value)}>
              ...
              <input type='button' className='logoutBtn' value="logout" onClick={logout} />
            </form>
        </div>
    </div>
  );
